...
const PublicRegister = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await authAPI.registerStudent(dataToSubmit); // Use registerStudent instead of registerPublic
              ...
              <div className="auth-card-body">
                ...
                <form className="auth-form" onSubmit={handleSubmit}>
                  ...
                  <Row>
                    ...
                    <Col md={6}>
                      <div className="auth-form-group">
                        <label className="auth-form-label required">Major/Study Program</label>
                        <input
                          type="text"
                          name="major"
                  ...
                  <div className="auth-form-check">
                    <input
                      type="checkbox"
                      className="auth-form-check-input form-check-input"
                      id="terms"
                      required
                    />
                    <label className="auth-form-check-label form-check-label" htmlFor="terms">
                ...
                <div className="auth-info-section">
                  <p className="auth-info-text">
                    ...
                    By registering, you'll be able to create and manage student activities,
                    submit proposals, and participate in university events.
                  </p>
                </div>
              </div>
            </div>
